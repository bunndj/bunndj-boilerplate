          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Link to="/admin/users" className="bg-brand hover:bg-brand-dark text-white p-4 rounded-lg text-center">
                  <Users className="w-8 h-8 mx-auto mb-2" />
                  Manage Users
                </Link>
                <Link to="/admin/events" className="bg-blue-500 hover:bg-blue-600 text-white p-4 rounded-lg text-center">
                  <Calendar className="w-8 h-8 mx-auto mb-2" />
                  All Events
                </Link>
                <Link to="/profile" className="bg-gray-500 hover:bg-gray-600 text-white p-4 rounded-lg text-center">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Link to="/client/events" className="bg-brand hover:bg-brand-dark text-white p-4 rounded-lg text-center">
                  <Calendar className="w-8 h-8 mx-auto mb-2" />
                  My Events
                </Link>
                <Link to="/profile" className="bg-gray-500 hover:bg-gray-600 text-white p-4 rounded-lg text-center">
      ...
      return (
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Link to="/events" className="bg-brand hover:bg-brand-dark text-white p-4 rounded-lg text-center">
                  <Calendar className="w-8 h-8 mx-auto mb-2" />
                  My Events
                </Link>
                <Link to="/profile" className="bg-gray-500 hover:bg-gray-600 text-white p-4 rounded-lg text-center">
